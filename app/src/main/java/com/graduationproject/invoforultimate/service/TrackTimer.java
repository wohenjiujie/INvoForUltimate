...
import com.graduationproject.invoforultimate.connector.MyTrackTimer;
...
public class TrackTimer extends TimerTask implements MyTrackTimer {
    ...
    public void updateTrack() {
        String content = SEARCH_TRACK_HISTORY + Constants.ServiceID + "&tid=" + TerminalInfo.getTerminal() + "&trid=" + object + "&pagesize=999";
